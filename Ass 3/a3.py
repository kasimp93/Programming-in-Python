...
def board_contains_word(board, word):
    ...
    True
    """
    if board_contains_word_in_column(board, word) == True or board_contains_word_in_row(board, word):
        return True
    else:
        return False
...
def read_words(words_file):
    ...
    contents_list = words_file.readlines()
    words_list = []
    i = 0
...
def read_board(board_file):
    ...
    contents_list = board_file.readlines()
    board_list = []
    i = 0
    for i in range (len(contents_list)):
         a = contents_list[i]
